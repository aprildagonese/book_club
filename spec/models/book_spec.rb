  ...
  describe 'intance methods' do
    ...
    context "generating statistics for books index page " do
      ...
      it "should get the 3 highest rated book and 3 lowest rated books" do
        ...
        expect(Book.three_top_or_bottom_rated("DESC")).to include(book_7,book_2,book_6)
        expect(Book.three_top_or_bottom_rated("ASC")).to include(book_3, book_4, book_8)
      end
    ...
    context "generating statistics for books show page " do
      it "should get the top 3 reviews, bottom 3 views and average rating for all reviews for this book" do
        author_1 = Author.create(name: "John Smith")
    ...
    context "when visiting the book index page" do
      it "should see links to sort books by average ratings, pages or reviews count, ascending or descending" do
        author_1 = Author.create(name: "John Smith")
        author_2 = Author.create(name: "Jane Doe")
        author_3 = Author.create(name: "Maria Calix")
        author_4 = Author.create(name: "Don Johnson")
